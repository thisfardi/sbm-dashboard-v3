      ...
      item.items.forEach(_item => {
        tag += `
                    <tr>
                        ...
                        <td>${ item.total_price != 0 ? (_item.price / item.total_price * 100).toFixed(2) : 0}%</td>
                    </tr>
                `;
      })
      tag += `
                <tr>
                    ...
                    <td class="bg-soft-primary">${ total_price != 0 ? (item.total_price / total_price * 100).toFixed(2) : 0}%</td>
                </tr>
            `;
    })
    tag += `
